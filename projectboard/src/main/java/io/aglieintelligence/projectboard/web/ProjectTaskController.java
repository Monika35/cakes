package io.aglieintelligence.projectboard.web;

import io.aglieintelligence.projectboard.domain.ProjectTask;
import io.aglieintelligence.projectboard.service.ProjectTaskService;
...
public class ProjectTaskController {
    ...
    public ResponseEntity<?> addPTToBoard(@Valid @RequestBody ProjectTask projectTask, BindingResult result){
        ...
        ProjectTask newPT=projectTaskService.saveOrUpdataProjectTask(projectTask);
